    ...
    <el-row :gutter="10" style="width: 100%">
      ...
      >
        ...
        >
          ...
          <el-table-column width="180" align="center" prop="order_name" label="Инвойс №" />
              ...
              <el-popover placement="right" trigger="hover">
                <el-table :show-header="false" :data="gridData(scope.row.products)">
                  ...
                  <el-table-column align="center" width="100" property="value" label="value">
                    <!-- eslint-disable-next-line -->
                    <template slot-scope="scope">
                      <span v-if="scope.row.isReturning || scope.row.action === 3" style="color: red">
          ...
          <el-table-column v-if="roles[0] === 'admin'" width="180" align="center" prop="last_sum" label="Кассаси">
            <template slot-scope="scope">
              <el-popover placement="right" trigger="hover">
          ...
          <el-table-column v-if="roles[0] === 'admin'" width="120" align="center" label="Касса">
            <template slot-scope="scope">
              ...
              >
                <el-checkbox :value="scope.row.did_cassa" @change="doKassaForNow(scope.row)" />
              </el-tooltip>
              <!-- <el-tooltip v-else>
          ...
          <el-table-column align="center" width="150" label="Сотув вақти" prop="createdAt">
            <template slot-scope="scope">
