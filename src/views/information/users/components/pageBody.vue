<template>
  <el-col :span="24" class="users-page-body">
    ...
    >
      ...
      <el-table-column align="center" prop="stuff" label="Ҳодим">
        <template slot-scope="scope">
          {{ scope.row.stuff.firstName + " " + scope.row.stuff.lastName }}
        </template>
      </el-table-column>
      <el-table-column align="center" prop="username" label="Логин" />
      <el-table-column align="center" prop="role" label="Роли">
        <template slot-scope="scope">
          {{ roleName[scope.row.role] }}
        </template>
      </el-table-column>
      <!-- <el-table-column align="center" prop="is_active" label="Роли">
        <template slot-scope="scope">
          {{ scope.row.is_active }}
        </template>
      </el-table-column> -->
