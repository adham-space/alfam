<template>
  <el-col :span="24" class="stuffs-page-body">
    ...
    >
      ...
      <el-table-column align="center" label="Тўлиқ исми">
        <template slot-scope="scope">
      ...
      <el-table-column width="150" align="center" prop="shop" label="Дўкон">
        <template slot-scope="scope">
          {{ scope.row.shop ? scope.row.shop.name : "" }}
        </template>
      </el-table-column>
      <el-table-column width="150" align="center" prop="date" label="Рег. дата">
        <template slot-scope="scope">
