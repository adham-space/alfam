<template>
  <el-col :span="24" class="orders-page-tools">
    ...
    <div style="display: flex">
      ...
      <el-button style="border: 1px solid transparent" icon="el-icon-plus" @click="$router.push('/shop/shop-packing-list')" />
      <el-button :disabled="!!!currentOrder" style="border: 1px solid transparent" icon="el-icon-edit" @click="editDialog = true" />
      <el-button :disabled="!!!currentOrder" style="border: 1px solid transparent; color: red" icon="el-icon-delete" @click="delete_Dialog = true" />
