      ...
      <el-card shadow="hover" class="box-card">
        ...
        <div class="one-packet">
          <span><span
                ...
                >AREA OF ONE ITEM: </span>{{ Object.keys(currentType).length > 0 ? areaOfOneItem() : "_" }}
          ...
          ><span
             style="color: darkgray; margin-right: 1rem"
           >AREA OF ONE PACKET: </span>{{ numberOfItems === "" ? "_" : areaOfOnePacket() }}
            <span style="color: darkgray">M<sup>2</sup></span></span>
          <span
            style="margin-top: 1rem"
          ><span
             style="color: darkgray; margin-right: 1rem"
           >WEIGHT OF AN ITEM: </span>{{ weightOfPacket === "" ? "_" : wightOfOneItem() }}
          ...
          children: [
            {
              ...
              photo: {
                ...
                uid: 1613977212930,
                raw: '[object File]',
                url: 'blob:http://localhost:9527/1b4b5fcb-600c-4a7c-8027-31ab63e0d148'
              }
            },
            {
              value: 1,
              ...
              photo: {
                ...
                uid: 1613977232481,
                raw: '[object File]',
                url: 'blob:http://localhost:9527/0ce56dd8-8004-47c5-b194-cabe40f4e34e'
              }
            },
            {
              value: 3,
              ...
              photo: {
                ...
                uid: 1613977257115,
                raw: '[object File]',
                url: 'blob:http://localhost:9527/b1a02b1a-4778-4ab9-9674-d8f418de214d'
              }
            },
            {
              value: 4,
