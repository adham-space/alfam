<template>
  <el-col :span="24" class="inventars-page-tools">
    <div style="display: flex">
      <el-select
        v-model="current_shop"
        placeholder="Диллер/Дўконни киритинг"
      ...
      <el-input
        ...
        clearable
        style="border: 1px solid transparent; width: 20rem"
        placeholder="Кафелни қидириш"
      ...
      <el-select
        ...
        style="width: 17rem; margin: 0 1em"
        placeholder="Return status"
        @change="returnStatusChanged"
      >
 ...
 -->
      <el-button
        ...
        icon="el-icon-plus"
        @click="$router.push('/sklad/storetproduct')"
      />
    </div>
  </el-col>
</template>
